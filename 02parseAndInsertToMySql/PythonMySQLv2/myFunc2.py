...
def insertAllPlayerScoresIntoDb(filePath, txtFile, mycursor, mydb):
    ...
    fff = "INSERT INTO t" + txtFile[0:8] + " values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s," \
          " %s, %s, %s, %s, %s, %s)"
    ...
    linesTraveled = 13
    fff = "INSERT INTO t" + txtFile[0:8] + " values (%s, %s, %s, 'NA', %s , %s, %s, %s, %s, %s, %s, %s, %s, %s, " \
    ...
    for i in range(0, visitorLinesRemaining):
        ...
        if(lineList[3] == 'DND' or lineList[3] == 'DNP' or lineList[3] == 'NWT'):
            fff = "INSERT INTO t" + txtFile[0:8] + " values (%s, %s, %s, 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', " \
